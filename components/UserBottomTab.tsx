...
export default function UserBottomNav({ active = "Dashboard", navigation }: any) {
  return (
    <View className="absolute left-0 right-0 bottom-0 pb-2 flex-row bg-white border-t border-gray-200 h-20 items-center justify-around z-50">
      ...
      <TouchableOpacity className="items-center flex-1" onPress={() => navigation.navigate('UserCreatePass')}>
